...
public class RoomTablePrintable extends TablePrintableBase {

    public RoomTablePrintable(JTable tableToPrint, String universityTitle, String dynamicFilterInfo, List<String> visibleColumns) {
    ...
    protected List<Integer> getColumnWidths(Graphics2D g2d, Font headerFont, Font cellFont, JTable table,
        ...
        for (String colName : visibleColumns) {
            ...
            } else if ("Type".equalsIgnoreCase(headerText)) {
                maxWidth = (int) (maxWidth * typeWeight);
