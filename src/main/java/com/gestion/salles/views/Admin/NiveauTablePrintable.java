...
public class NiveauTablePrintable extends TablePrintableBase {

    public NiveauTablePrintable(JTable tableToPrint, String universityTitle, String dynamicFilterInfo, List<String> visibleColumns) {
    ...
    protected List<Integer> getColumnWidths(Graphics2D g2d, Font headerFont, Font cellFont, JTable table,
        ...
        double codeWeight = 1.2;
        double departementWeight = 1.2;
        double blocWeight = 1.2;
        ...
        for (String colName : visibleColumns) {
            ...
            } else if ("Code".equalsIgnoreCase(headerText)) {
                maxWidth = (int) (maxWidth * codeWeight);
            } else if ("Faculté".equalsIgnoreCase(headerText)) {
                maxWidth = (int) (maxWidth * departementWeight);
            } else if ("Département".equalsIgnoreCase(headerText)) {
                maxWidth = (int) (maxWidth * blocWeight);
            }
